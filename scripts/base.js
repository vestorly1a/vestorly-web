...
function recentpost()
{
  ...
  Vestorly.getAllArticle(15, query, function(data) {
    ...
    for (var i = 0; i < articles.length; ++i) {
      ...
      contentUrl.setAttribute('href',articles[i].external_url);
      ...
      var articleSourceLinkText = document.createTextNode(
          "Sourced from: " + parse(articles[i].external_url));
